----------------------------------------------------------------------------------------
--
-- File name:   translator_logon_trigger.sql
--
...
--
--              Note that the sys.FOO package does not need to exist. The Translation 
--              Profile can contain mappings of individual statements and any statements
--              that are not mapped will be passed through without modification. There
--              is however a bug in 12cR1 that causes the SQL_ID and HASH_VALUE to be 
--              calculated incorrectly for statements that are passed through without
--              translation. 
---------------------------------------------------------------------------------------
